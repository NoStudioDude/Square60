...
public class BlueUIMAnager : MonoBehaviour {
    ...
    public void OnLevelDown(LevelScript lvlScript)
    {
        if (lvlScript.isEnable)
        {
            ...
            {
                case "Blue":
                    PlayerPrefs.SetString(PlayerPrefsHelper.currentFolderLevel, "Blue");

                    switch (lvlScript.mylevel)
                    {
                        case 1:
                            PlayerPrefs.SetInt(PlayerPrefsHelper.currentLevel, 1);
                            Application.LoadLevel(ScenesNames.SceneBlueLevel1);
                            break;
                        case 2:
                            PlayerPrefs.SetInt(PlayerPrefsHelper.currentLevel, 2);
                            Application.LoadLevel(ScenesNames.SceneBlueLevel2);
                            break;
                        case 3:
                            PlayerPrefs.SetInt(PlayerPrefsHelper.currentLevel, 3);
                            Application.LoadLevel(ScenesNames.SceneBlueLevel3);
                            break;
                        case 4:
                            PlayerPrefs.SetInt(PlayerPrefsHelper.currentLevel, 4);
                            Application.LoadLevel(ScenesNames.SceneBlueLevel4);
                            break;
                        case 5:
                            PlayerPrefs.SetInt(PlayerPrefsHelper.currentLevel, 5);
                            Application.LoadLevel(ScenesNames.SceneBlueLevel5);
                            break;
                        case 6:
                            PlayerPrefs.SetInt(PlayerPrefsHelper.currentLevel, 6);
                            Application.LoadLevel(ScenesNames.SceneBlueLevel6);
                            break;
                        case 7:
                            PlayerPrefs.SetInt(PlayerPrefsHelper.currentLevel, 7);
                            Application.LoadLevel(ScenesNames.SceneBlueLevel7);
                            break;
                        case 8:
                            PlayerPrefs.SetInt(PlayerPrefsHelper.currentLevel, 8);
                            Application.LoadLevel(ScenesNames.SceneBlueLevel8);
                            break;
                        case 9:
                            PlayerPrefs.SetInt(PlayerPrefsHelper.currentLevel, 9);
                            Application.LoadLevel(ScenesNames.SceneBlueLevel9);
                            break;
                        case 10:
                            PlayerPrefs.SetInt(PlayerPrefsHelper.currentLevel, 10);
